...
const movies_detail = [
 ...
 {id:2, poster:"images/39614_1000.jpg" , title:"해리포터와 죽음의 성물 2", entitle: "Harry Potter And The Deathly Hallows: Part2",  dir:"데이빗 예이츠", act:"다니엘 래드클리프 ,  엠마 왓슨 ,  루퍼트 그린트", gen:"환타지, 어드벤처", bas:" 131분, 미국, 영국", age:"H_all", ticketing:"9.1%", open:"2011.07. 14", link:"_31zwi0U8NE",
 ...
 {id:3, poster:"images/85712_320.jpg" , title:"신비한 동물들과 덤블도어의 비밀", entitle:"Fantastic Beasts: The Secrets of Dumbledore", dir:"데이빗 예이츠", act:"에디 레드메인 ,  주드 로 ,  매즈 미켈슨 ,  댄 포글러 ,  앨리슨 수돌 ,  에즈라 밀러 ,  칼럼 터너 ,  제시카 윌리엄스 ,  빅토리아 예이츠 ,  윌리엄 나딜람 ,  리처드 코일", gen:"어드벤처, 가족, 환타지", bas:"142분, 미국", age:"H_12", ticketing:"9.0%", open:"2022.04.14", link:"DGhq0Kx8dzQ",
   detail_title:`가장 위험한 마법에 맞선, 세상을 구할 전쟁이 시작된다!`,
   detail: `1930년대, 제2차 세계대전에 마법사들이 개입하게 되면서
   강력한 어둠의 마법사 그린델왈드의 힘이 급속도로 커진다.
 ...
 {id:4, poster:"images/85641_1000.jpg" , title:"해리 포터와 불사조 기사단", entitle:"Harry Potter And The Order Of The Phoenix", dir:"데이빗 예이츠", act:"다니엘 래드클리프 ,  엠마 왓슨 ,  루퍼트 그린트", gen:"환타지, 액션, 어드벤처", bas:"137분, 미국, 영국", age:"H_all", ticketing:"9.0%", open:"2007.7.12", link:"y6ZW7KXaXYk",
 ...
 {id:5, poster:"images/76791_1000.jpg" , title:"신세계", entitle:"New World", dir:"박훈정", act:"이정재 ,  황정민 ,  최민식 ,  박성웅 ,  송지효", gen:"범죄, 액션", bas:"134분, 한국",  age:"H_19", ticketing:"8.7%", open:"2013.2.21", link: "rvLMVcRkRfY",
 ...
 {id:6, poster:"images/80810_1000.jpg" , title:"신과함께 인과연", entitle:"Along with the Gods: The Last 49 Days", dir:"김용화", act:"하정우 ,  주지훈 ,  김향기 ,  마동석 ,  김동욱 ,  이정재", gen:"환타지, 드라마", bas:"141분, 한국",  age:"H_12", ticketing:"8.6%", open:"2018.08.01", link:"amXcMw8cJZk",
 detail: `환생이 약속된 마지막 49번째 재판을 앞둔 저승 삼차사가 그들의 천 년 전 과거를 기억하는 성주신을 만나이승과 저승,
 과거를 넘나들며 잃어버린 비밀의 연을 찾아가는 이야기.` },
 
 {id:7, poster:"images/85603_320.jpg" , title:"극장판 주술회전 0", entitle:"Jujutsu Kaisen: Zero", dir:"박성후", act:"오가타 메구미 ,  하나자와 카나 ,  코마츠 미카코 ,  우치야마 코우키 ,  세키 토모카즈 ,  나카무라 유이치 ,  사쿠라이 타카히로", gen:"애니메이션", bas:"105분, 일본",age:"H_15", ticketing:"2.1%", open:"2022.02.17", link:"-iun6KPT4SM",
